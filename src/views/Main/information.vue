<template>
    <div id="info">
        <div class="info_wrap">
            ...
            <template v-else>
                <div class="contentList">
                    <dl v-for="(item,idx) in infoList">
                        <dt>
                            <img :src="item.amtopics" alt="" @click="gotoDetail(item.amid)" />
                        </dt>
                        <dd>
...
<script>
    export default {
        ...
        async created() {
            ...
            this.infoList = res.data.information.items;
            this.total = res.data.information.totalCount;
            this.currentPage = 1;
        },
        methods:{
            gotoDetail(amid) {
            ...
            async changePage(num) {
                ...
                console.log(requery);
                this.infoList = requery.data.information.items;
                this.total = requery.data.information.totalCount;
